<%@ Page Title="项目首页" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="SubPortal3.aspx.cs" Inherits="IntegratedManage.Web.SubPortal3" %>
    ...
    <script type="text/javascript">
        ...
        function onPgLoad() {
            ...
            if (!curMdl["Url"] && $('.accordion-nav li a')[0]) {
                ...
                //subFrameContent.location.href = $('.accordion-nav li a')[0].href
            }
        }
