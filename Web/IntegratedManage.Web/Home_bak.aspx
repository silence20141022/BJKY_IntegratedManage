<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home_bak.aspx.cs" Inherits="IntegratedManage.Web.Home_bak"
    CodePage="936" %>
...
<head>
    ...
    <script src="/Modules/WebPart/tabJs.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function addBlock(blocktype, blocktitle) {
            ...
            queryString = "asyncreq=true&Param=GetOneNew&BlockId=" + blocktype + "&BlockType=" + _blockType + "&DeptId=" + DeptId + "&" + _params;
	...
	(
        ...
        function delDragDiv(blockid) {
            ...
            if (logicv) {
                ...
                url = "/CommonPages/Data/HomeData.aspx";
                queryString = "Param=DeleteBlock&BlockId=" + blockid + "&BlockType=" + _blockType + "&DeptId=" + DeptId + "&" + _params;
        ...
        function myRssDiv(blockid) {
            ...
            url = "/CommonPages/Data/HomeData.aspx";
            queryString = "Param=MyRss&BlockId=" + blockid + "&BlockType=" + _blockType + "&DeptId=" + DeptId;
            new Ajax.Request
	(
		url,
		{
        ...
        function reset() {
            if (confirm("确定要恢复默认吗?")) {
                url = "/CommonPages/Data/HomeData.aspx";
                queryString = "Param=Reset&BlockType=" + _blockType + "&DeptId=" + DeptId + "&" + _params;
                new Ajax.Request
		(
			url,
			{
        ...
        function modifyBlock(id) {
            ...
            url = "/CommonPages/Data/HomeData.aspx";
            queryString = "Param=BlockParam&BlockId=" + id + "&BlockType=" + _blockType + "&DeptId=" + DeptId + "&" + _params;
	...
	(
        ...
        function saveDragEditor(blockid) {
            ...
            url = "/CommonPages/Data/HomeData.aspx";
            queryString = "Param=BlockUpdate" + par + "&BlockType=" + _blockType + "&DeptId=" + DeptId + "&" + _params;
            new Ajax.Request
	(
		url,
		{
	...
	(
        ...
        function changeDragIcon(src, blockimg) {
            ...
            url = "/CommonPages/Data/HomeData.aspx";
            queryString = "Param=SetIcon&BlockId=" + blockid + "&BlockType=" + _blockType + "&DeptId=" + DeptId + "&BlockImg=" + src + "&" + _params;
            new Ajax.Request(url, { method: "post", parameters: queryString });
        ...
        function setLayoutType(n) {
            ...
            queryString += "&BlockType=" + _blockType + "&DeptId=" + DeptId;
            new Ajax.Request(url, { method: "post", parameters: queryString });
            unlockWindowPage();
        ...
        function loadColEdit() {
            ...
            url = "/CommonPages/Data/HomeData.aspx";
            queryString = "Param=GetAllBlock&BlockType=" + _blockType + "&DeptId=" + DeptId + "&" + _params;
            new Ajax.Request
	(
		url,
		{
        ...
        function openBlocks() {
            OpenWin("/Modules/PubNews/NewsTypeList.aspx?DeptId=" + DeptId, "_Blank", CenterWin("width=800,height=600,resizable=yes,scrollbars=yes"));
        }
    </script>

</head>
<body style="margin-right: 0px; overflow-y: auto">
    <div style="width: 350px" id='fucbtns'>
            ...
            <img class="imglink" id="controlPopupConMenu" title="添加修改首页内容" style="margin-left: 10px"
                src="/Modules/WebPart/add.gif"><img class="imglink" id="drag_switch_img_all" title="展开/隐藏所有元素"
                    style="margin-left: 5px" src="/Modules/WebPart/open.gif"><img class="imglink" id="reset"
                        title="恢复默认" style="margin-left: 5px" src="/Modules/WebPart/refresh.gif" onclick="reset();">&nbsp;&nbsp;<span
                            style="cursor: hand; color: Blue; text-decoration: underline;display:none;" id="blockDept"
                            onclick="openBlocks();">部门栏目维护</span>
        </div>
        <div id="inittext" style="float: left; width: 100px; color: #999; height: 20px">
        </div>
    </div>
    <div id="Divlayout" style="width: 99.5%">
        <%=Html%>
    </div>
    ...
    <script type="text/javascript">
        ...
        window.onload = function() {
            ...
            DeptId = QueryString("DeptId") == "" ? "" : QueryString("DeptId");
            //_params = "TemplateId="+GetQueryString("TemplateId")+"&IsManage="+GetQueryString("IsManage");
            if (QueryString("IsManage") == "T") {
                document.getElementById("blockDept").style.display = "";
            }
            if (_blockType == "DeptPortal" || QueryString("IsDeptManage") == "T") {
                try {
                    document.getElementById("Divlayout").style.width = document.body.offsetWidth - 30;
                    if (QueryString("Redirect") == "T")
                        document.getElementById("Divlayout").childNodes[0].style.width = parseInt(document.getElementById("Divlayout").childNodes[0].style.width.substring(0, document.getElementById("Divlayout").childNodes[0].style.width.length - 1)) - 1 + "%";
                    //alert(document.getElementById("Divlayout").childNodes[0].style.width);
                } catch (e) { }
                if (QueryString("IsManage") != "T") {
                    document.getElementById("fucbtns").style.display = "none";
                }
            }
        }
    ...
    <script language="javascript">
        ...
        function OpenNews(NewsUrl) {
            ...
            if (arguments.length > 4&&arguments[1]!="") {
                ...
                OpenWin(NewsUrl, "_Blank", CenterWin("width=1100,height=700,resizable=yes,scrollbars=yes"));
        }
