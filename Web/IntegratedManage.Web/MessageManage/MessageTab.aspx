<%@ Page Title="消息管理" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="MessageTab.aspx.cs" Inherits="IntegratedManage.Web.MessageManage.MessageTab" %>
        ...
        function setPgUI() {
            ...
            var viewport = new Ext.ux.AimViewport({
                ...
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "MessageList.aspx?Index=0";
                }
            }
            function handleActivate(tab) {
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "MessageList.aspx?Index=" + tabpanel.activeTab.tooltip;
                }
            }
    </script>
