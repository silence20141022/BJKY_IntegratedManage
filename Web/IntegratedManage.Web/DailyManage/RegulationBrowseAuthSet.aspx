<%@ Page Title="规章制度" Language="C#" MasterPageFile="~/Masters/Ext/formpage.Master"
    AutoEventWireup="true" CodeBehind="RegulationBrowseAuthSet.aspx.cs" Inherits="IntegratedManage.Web.RegulationBrowseAuthSet" %>
            ...
            <table class="aim-ui-table-edit">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input type="hidden" style="width: 98%" id="Files" name="Files" aimctrl='file' filter='(*.docx;*.doc;*.xls)|*.docx;*.doc;*.xls'
                                value="" />
                        </td>
                    </tr>
        ...
        <table>
            <tr>
                <td class="aim-ui-button-panel" colspan="4" style="border-top: none;">
                    <a id="btnSubmit" class="aim-ui-button submit">提交</a> <a id="btnCancel" class="aim-ui-button cancel">取消</a>
                </td>
            </tr>
        </table>
