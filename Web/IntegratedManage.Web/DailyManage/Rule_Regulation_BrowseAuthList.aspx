<%@ Page Title="标题" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="Rule_Regulation_BrowseAuthList.aspx.cs" Inherits="IntegratedManage.Web.Rule_Regulation_BrowseAuthList" %>

<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">

    <script type="text/javascript">
        var EditWinStyle = CenterWin("width=650,height=600,scrollbars=yes");
        var EditPageUrl = "Rule_Regulation_BrowseAuthEdit.aspx";
        ...
        function setPgUI() {
            ...
            myData = {
                ...
                records: AimState["Rule_Regulation_BrowseAuthList"] || []
            };

            // 表格数据源
            store = new Ext.ux.data.AimJsonStore({
                dsname: 'Rule_Regulation_BrowseAuthList',
                idProperty: 'Id',
                data: myData,
                fields: [
			{ name: 'Id' },
