...
{
    public partial class Rule_Regulation_AdminAuthList : IMListPage
    {
        #region 变量

        private IList<Rule_Regulation_AdminAuth> ents = null;
        string id = "";
        ...
        {
            Rule_Regulation_AdminAuth ent = null;
            id = RequestData.Get<string>("id");
            switch (this.RequestAction)
            {
                case RequestActionEnum.Delete:
                    ent = this.GetTargetData<Rule_Regulation_AdminAuth>();
                    ent.DoDelete();
        ...
        {
            //SearchCriterion.AddSearch("Prop_Rule_Regulation", id);
            ents = Rule_Regulation_AdminAuth.FindAll(SearchCriterion, Expression.Eq("Rule_Regulation", id));
            this.PageState.Add("Rule_Regulation_AdminAuthList", ents);
        }
        ...
        private void DoBatchDelete()
        {
            ...
            {
                Rule_Regulation_AdminAuth.DoBatchDelete(idList.ToArray());
            }
        }
