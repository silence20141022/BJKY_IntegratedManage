<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true" CodeBehind="TaskMaint.aspx.cs" Inherits="Aim.AM.Web.Aim.Task.TaskMaint" %>
...
<script src="/js/ext/ux/TabScrollerMenu.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function onPgLoad() {
            mdls = [{ Name: "待处理", Url: "TaskList.aspx?Status=0", Status: 0 }, { Name: "已提交", Url: "TaskList.aspx?Status=1", Status: 1}];
