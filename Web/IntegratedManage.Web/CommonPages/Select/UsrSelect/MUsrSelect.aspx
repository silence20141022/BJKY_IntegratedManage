    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            { xtype: 'button', text: '取消', handler: function() { window.close(); } }]
                ...
                var url = "UsrSelView.aspx";
                if ($.getQueryString({ ID: "GroupID", DafaultValue: "" }) != "") {
                    url += "?ctype=group&id=" + $.getQueryString({ ID: "GroupID" });
                }
                // 页面视图
            ...
            },
            {
                ...
                cls: 'empty',
                bodyStyle: 'background:#f1f1f1',
                html: '<iframe width="100%" height="100%" id="usrViewFrame" name="frameContent" frameborder="0" src="' + url + '"></iframe>'
            }, selPanel, cmdPanel]
                });
            }
            ...
            function InitSelections() {
                ...
                if ($.getQueryString({ ID: "UserID", DefaultValue: "" }) != "") {
                    uids = $.getQueryString({ ID: "UserID", DefaultValue: "" }).split(",");
                    unames = unescape($.getQueryString({ ID: "Name", DefaultValue: "" })).split(",");
                }
                else {
                    uids = (pval["UserID"] || "").split(",");
                    unames = (pval["Name"] || "").split(",");
                }
                var rtndata = [];
