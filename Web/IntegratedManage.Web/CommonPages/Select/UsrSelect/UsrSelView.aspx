<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="UsrSelView.aspx.cs" Inherits="IntegratedManage.Web.CommonPages.UsrSelView" %>
        ...
        function setPgUI() {
            ...
            grid.on("rowclick", function(grid, rowIndex, e) {
                ...
                if (typeof (parent.OnSelViewRowClick) == 'function') {
                    parent.OnSelViewRowClick.call(this, rec, { type: 'user' });
                }
            });
            ...
            grid.on("rowdblclick", function(grid, rowIndex, e) {
                ...
                if (typeof (parent.OnSelViewRowDblClick) == 'function') {
                    parent.OnSelViewRowDblClick.call(this, rec, { type: 'user' });
                }
            });
