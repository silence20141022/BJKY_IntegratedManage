<%@ Page Title="信息列表" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="FrmVideoNewsList.aspx.cs" Inherits="Aim.Portal.Web.FrmVideoNewsList" %>
            ...
            var schBar = new Ext.ux.AimSchPanel({
                ...
                var tlBar = new Ext.ux.AimToolbar({
                    items: [{
                        ...
                        handler: function() {
                            openEditWin("FrmVideoNewsEdit.aspx?TypeId=" + typeId, "c");
                        }
                    }, {
                        text: '修改',
                        ...
                        handler: function() {
                            ...
                            openEditWin("FrmVideoNewsEdit.aspx", "u");
                        }
                    }, {
                        text: '删除',
                    ...
                    grid = new Ext.ux.grid.AimGridPanel({
					    ...
					    { id: 'CreateTime', header: '创建日期', width: 100, renderer: ExtGridDateOnlyRender, sortable: true, dataIndex: 'CreateTime' },
