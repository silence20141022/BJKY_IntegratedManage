<%@ Page Title="视频新闻信息列表" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master"
    AutoEventWireup="true" CodeBehind="FrmVideoNewsCreateList.aspx.cs" Inherits="Aim.Portal.Web.FrmVideoNewsCreateList" %>
...
<asp:Content ID="HeadHolder" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        var EditPageUrl = "FrmVdeoNewsView.aspx";
        ...
        function setPgUI() {
            ...
            store = new Ext.ux.data.AimJsonStore({
                ...
                { name: 'ShowImg' },
                { name: 'Title' },
                { name: 'ReceiveDeptId' }, { name: 'ReceiveDeptName' }, { name: 'Ext1' },{name:'PostDeptName'},
                { name: 'PostUserId' },
                { name: 'PostUserName' },
                { name: 'PostTime' },
                { name: 'ExpireTime' },
            ...
            var schBar = new Ext.ux.AimSchPanel({
                ...
                var tlBar = new Ext.ux.AimToolbar({
                    items: [{
                        ...
                        handler: function() {
                            openEditWin("FrmVideoNewsCreateEdit.aspx?TypeId=" + typeId, "c");
                        }
                    }, {
                        text: '修改',
                        ...
                        handler: function() {
                            ...
                            if (recs[0].data.State && recs[0].data.State != "0") {
                                AimDlg.show("已发布的消息不能修改！");
                                return;
                            }
                            openEditWin("FrmVideoNewsCreateEdit.aspx", "u");
                        }
                    }, {
                        text: '删除',
                    ...
                    grid = new Ext.ux.grid.AimGridPanel({
					    ...
					    { id: 'CreateName', header: '发布人', width: 100, sortable: true, dataIndex: 'CreateName' },
					    ...
					    { id: 'Ext1', dataIndex: 'Ext1', header: '观看次数', width: 80, sortable: true },
