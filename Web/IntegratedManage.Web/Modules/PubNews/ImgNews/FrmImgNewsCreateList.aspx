<%@ Page Title="图片信息列表" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master"
    AutoEventWireup="true" CodeBehind="FrmImgNewsCreateList.aspx.cs" Inherits="Aim.Portal.Web.Modules.PubNews.FrmImgNewsCreateList" %>
            ...
            var schBar = new Ext.ux.AimSchPanel({
                ...
                var tlBar = new Ext.ux.AimToolbar({
                    items: [{
                        ...
                        handler: function() {
                            openEditWin("FrmImgNewsCreateEdit.aspx?TypeId=" + typeId, "c");
                        }
                    }, {
                        text: '修改',
                        ...
                        handler: function() {
                            ...
                            openEditWin("FrmImgNewsCreateEdit.aspx", "u");
                        }
                    }, {
                        text: '删除',
