<%@ Page Title="信息列表" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="NewsList.aspx.cs" Inherits="Aim.Portal.Web.Modules.PubNews.NewsList" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            store = new Ext.ux.data.AimJsonStore({
                ...
                fields: [
                { name: 'Id' },
			    { name: 'Title' }, { name: 'PostDeptName' }, { name: 'ReadCount' },
			    { name: 'TypeId' },
			    { name: 'PostUserId' },
			    { name: 'PostUserName' },
			    { name: 'PostTime' },
			    ...
			    { name: 'State' }
			        ...
			        options.data.checkstate = $.getQueryString({ "ID": "checkstate" });
			    }
			    }
            });
            ...
            var schBar = new Ext.ux.AimSchPanel({
                ...
                columns: 5,
                items: [
				{ fieldLabel: '类型', anchor: '90%', blankText: "全部", style: { marginTop: '-1px' }, id: 'TypeId', name: 'TypeId', xtype: 'aimcombo', enumdata: AimState["EnumType"], schopts: { qryopts: "{ mode: 'Like', field: 'TypeId' }"} },
            ...
            var tlBar = new Ext.ux.AimToolbar({
                items: [{
                    ...
                    handler: function () {
                        openEditWin("ImgNews/FrmImgNewsEdit.aspx?TypeId=146156a0-34a4-4c8e-9e51-0d9c5b4588c9", "c");
                    }
                }, {
                    text: '添加视频新闻',
                    iconCls: 'aim-icon-add',
                    handler: function () {
                        openEditWin("VideoNews/FrmVideoNewsEdit.aspx?TypeId=edd6f523-065f-4169-a855-8df11faf8ab2", "c");
                    }
                }, {
                    text: '修改',
                    ...
                    handler: function () {
                        ...
                        if (recs[0].data.NewsType == "视频") {
                            var url = "VideoNews/FrmVideoNewsEdit.aspx";
                        }
                        else if (recs[0].data.NewsType == "图片") {
                            var url = "ImgNews/FrmImgNewsEdit.aspx";
                        }
                        else {
                    ...
                    handler: function () {
                        ...
                        for (var i = 0; i < recs.length; i++) {
                            if (recs[i].data.State && recs[i].data.State == "2") {
            ...
            grid = new Ext.ux.grid.AimGridPanel({
                ...
                columns: [
					    ...
					    { id: 'Title', header: '标题', width: 100, renderer: function (v, p, c) {
					    ...
					    { id: 'ReadCount', header: '阅读次数', width: 80, sortable: true, dataIndex: 'ReadCount' },
