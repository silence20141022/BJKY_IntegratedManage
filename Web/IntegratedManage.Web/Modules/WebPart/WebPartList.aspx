<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="WebPartList.aspx.cs" Inherits="Aim.Portal.Web.WebPartList" %>

<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">

    <script type="text/javascript">
        var StatusEnum = { '1': '有效', '0': '无效' };
        var EnumBlock = null; //{ "portal": "个人门户", "Home": "公司门户", "Report": "综合报表" };
        ...
        function setPgUI() {
			...
			{ name: 'DeptName' }
			    ...
			    options.data.BlockType = blockType;
			}
			}
            });
            ...
            { layout: 'form', unstyled: true, columnWidth: .33,
            items: [new Ext.app.AimSearchField({ fieldLabel: 'Key', anchor: '90%', name: 'Key', store: store, aimgrp: "usrgrp", qryopts: "{ mode: 'Like', field: 'Key' }" })]
            }]
            });*/
            schBar = new Ext.ux.AimSchPanel({
                ...
                { fieldLabel: 'Key', id: 'Key', schopts: { qryopts: "{ mode: 'Like', field: 'Key' }"}}]
            });
            ...
            tlBar = new Ext.Toolbar({
                items: [{
                    ...
                    handler: function() {
                        openEditWin("WebPartEdit.aspx?BlockType=" + blockType, "c");
                    }
                }, {
                    text: '修改',
            ...
            grid = new Ext.ux.grid.AimGridPanel({
                ...
                columns: [
					...
					{ id: 'BlockType', header: '类型', width: 100, sortable: true, dataIndex: 'BlockType', enumdata: EnumBlock },
            ...
            for (var item in EnumBlock) {
                ...
                btns.push(tempbar);
                //tlBar.addButton(tempbar);
                //tlBar2.insertButton(index, tempbar);
                index++;
            }
        ...
        var TempButton1 = null;
        function SetButtonCss(obj) {
            if (TempButton1)
                TempButton1.removeClass("x-btn-click");
            TempButton1 = obj;
            obj.addClass("x-btn-click");
        }
        ...
        function openEditWin(url, op, style) {
            op = op || "r";
            style = style || CenterWin("width=900,height=550,scrollbars=yes");
