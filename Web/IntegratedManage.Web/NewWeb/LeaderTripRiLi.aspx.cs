...
{
    public partial class LeaderTripRiLi : IMListPage
    {
        string sql = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                case "create":
                    //ent = JsonHelper.GetObject<ChouJin>(jsonstr);
                    //ent.DoCreate();
                    //foreach (string str in shoukuanarray)
                    //{
                    //    ShouKuan skEnt = ShouKuan.Find(str);
                    //    skEnt.ChouJinId = ent.Id;
                    //    skEnt.DoUpdate();
                    //}
                    //PageState.Add("Result", ent.Id);
                    break;
                default:
                    DoSelect();
                    break;
