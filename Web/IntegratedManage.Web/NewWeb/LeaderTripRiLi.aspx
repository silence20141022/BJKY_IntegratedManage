<%@ Page Title="领导外出" Language="C#" MasterPageFile="~/Masters/Ext/IE8Site.Master"
    AutoEventWireup="true" CodeBehind="LeaderTripRiLi.aspx.cs" Inherits="IntegratedManage.Web.LeaderTripRiLi" %>
    ...
    <script type="text/javascript">
        ...
        function onPgLoad() {
            $("#btnBack").click(function () {
                window.location.href = "LeaderTripRiLi.aspx?op=u&currentWeek=" + (parseFloat(AimState["currentWeek"]) - 1) + "&year=" + AimState["year"];
            });
            ...
            grid = new Ext.ux.grid.AimGridPanel({
                ...
                listeners: { celldblclick: function (grid, rowIndex, columnIndex, e) {
                    ...
                    opencenterwin("LeaderTripEdit.aspx?UserIds=" + rec.get("UserIds") + "&ColumnId=" + columnId + "&TripId=" + tripid, "LeaderTripEdit", 900, 500);
                }
                }
            });
    ...
    <div class="panel panel-default">
        <div class=" panel-heading small" style="padding-bottom: 0px;">
            <ul class="nav nav-tabs" style="border-bottom-width: 0px">
                <li class="active"><a href="LeaderTripRiLi.aspx?op=u" style="color: black; font-weight: bolder">
