<%@ Page Title="领导外出" Language="C#" MasterPageFile="~/Masters/Ext/IE8Site.Master"
    AutoEventWireup="true" CodeBehind="LeaderTripTable.aspx.cs" Inherits="IntegratedManage.Web.LeaderTripTable" %>
    ...
    <script type="text/javascript">
        ...
        function onPgLoad() {
            ...
            $("#btnAdd").click(function () {
                opencenterwin("LeaderTripEdit.aspx?op=c", '', 900, 500);
            });
            ...
            grid = new Ext.ux.grid.AimGridPanel({
                ...
                //                    }
                //                    opencenterwin("LeaderTripEdit.aspx?op=u&UserIds=" + rec.get("UserIds") + "&ColumnId=" + columnId + "&TripId=" + tripid, "LeaderTripEdit", 900, 500);
                //                }
                //                }
            });
    ...
    <div class="panel panel-default">
        <div class=" panel-heading small" style="padding-bottom: 0px;">
            <ul class="nav nav-tabs" style="border-bottom-width: 0px">
                ...
                <li class="active"><a href="LeaderTripTable.aspx?op=u" style="color: black; font-weight: bolder">
                    <span class="fa fa-table"></span>表格视图</a></li>
            ...
            <tr>
                <td style="width: 13%">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" class=" form-control" id="UserNames_s" />
                    </div>
                </td>
                <td style="width: 15%">
                    <div class="input-group  input-group-sm">
                ...
                <td>
                    <div class="btn-group">
                        <a class="btn btn-primary btn-sm" id="btnAdd"><span class="fa fa-plus-square"></span>
                            <strong>添 加</strong></a><a class="btn btn-primary btn-sm" id="btnModify"><span class="fa fa-pencil-square-o">
                            </span><strong>修 改</strong></a><a class="btn btn-primary btn-sm" id="btnDelete"><span
