    ...
    $.fn.KinSlideshow = function(settings) {
        ...
        function KSS_setTitleFont() {
            if (settings.isHasTitleFont) {
                $(ksthis).append("<div class='KSS_titleBox'><h2 class='title' style='margin:0px 0px 0px 5px;padding:0;'></h2></div>");
                $(ksbs + " .KSS_titleBox").css({ height: getTitleBar_Height, width: "60%", position: "absolute", bottom: 0, left: 0 })
        ...
        function KSS_setBtn() {
            ...
            if (settings.isHasBtn && KSS_imgaeLength >= 2) {
                $(ksthis).append("<div class='KSS_btnBox' style='position:absolute;right:5px;bottom:3px; z-index:100'></div>");
                var KSS_btnList = "";
