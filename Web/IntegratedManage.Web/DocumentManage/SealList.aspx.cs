...
{
    public partial class SealList : IMListPage
    {
        private IList<Seal> ents = null;
        string sql = "";
        ...
        private void DoSelect()
        {
                ...
                if (!String.IsNullOrEmpty(item.Value.ToString()))
                {
                    switch (item.PropertyName)
                    {
                        ...
                        case "EndDate":
                            ...
                            break;
                        default:
                            if (item.PropertyName == "SealType" && item.Value.ToString() == "全部")
                            {
            ...
            sql = @"select * from BJKY_IntegratedManage..Seal where 1=1 " + where;
