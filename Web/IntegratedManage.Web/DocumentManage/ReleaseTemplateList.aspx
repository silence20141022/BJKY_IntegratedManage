<%@ Page Title="发布模板" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="ReleaseTemplateList.aspx.cs" Inherits="IntegratedManage.Web.DocumentManage.ReleaseTemplateList" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            schBar = new Ext.ux.AimSchPanel({
                ...
                columns: 5,
                items: [
                    { fieldLabel: '模板名称', id: 'Title', schopts: { qryopts: "{ mode: 'Like', field: 'Title' }"} },
            ...
            tlBar = new Ext.ux.AimToolbar({
                items: [{
                    ...
                    handler: function() {
                        opencenterwin("ReleaseTemplateEdit.aspx?op=c", "", 1000, 650);
                    }
                }, '-', {
                    text: '修改',
                    ...
                    handler: function() {
                        ...
                        opencenterwin("ReleaseTemplateEdit.aspx?op=u&id=" + recs[0].get("Id"), "", 1000, 650);
                    }
                }, '-', {
                    text: '删除',
            ...
            grid = new Ext.ux.grid.AimGridPanel({
                ...
                columns: [
                    ...
                    { id: 'Title', dataIndex: 'Title', header: '模板名称', width: 260, renderer: RowRender, sortable: true },
        ...
        function showwin(val) {
            ...
            task.delay(50, function() {
                opencenterwin("ReleaseTemplateEdit.aspx?op=v&id=" + val, "", 1200, 650);
            });
        }
