<%@ Page Title="发布模板选择" Language="C#" MasterPageFile="~/Masters/Ext/formpage.Master"
    AutoEventWireup="True" CodeBehind="ReleaseTemplateSelect.aspx.cs" Inherits="IntegratedManage.Web.DocumentManage.ReleaseTemplateSelect" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            store = new Ext.ux.data.AimJsonStore({
                ...
                data: myData,
                fields: [
                { name: 'Id' }, { name: 'Title' }, { name: 'TemplateContent' },
            ...
            schBar = new Ext.ux.AimSchPanel({
                ...
                columns: 4,
                collapsed: false,
                items: [{ fieldLabel: '模板名称', id: 'Title', schopts: { qryopts: "{ mode: 'Like', field: 'Title' }"} }
                ]
            });
            ...
            tlBar = new Ext.ux.AimToolbar({
                ...
                var buttonPanel = new Ext.form.FormPanel({
                    ...
                    AimSelGrid = new Ext.ux.grid.AimGridPanel({
                        ...
                        { id: 'Title', dataIndex: 'Title', header: '模板名称', width: 160, renderer: RowRender },
