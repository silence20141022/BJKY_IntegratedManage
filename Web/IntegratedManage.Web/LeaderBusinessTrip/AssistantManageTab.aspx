<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="AssistantManageTab.aspx.cs" Inherits="IntegratedManage.Web.AssistantManageTab" %>
        ...
        function setPgUI() {
            ...
            var viewport = new Ext.ux.AimViewport({
                ...
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "AssistantCalendarView.aspx?type=assistant";
                }
            }
            function handleActivate(tab) {
                if (document.getElementById("frameContent")) {
                    switch (tab.title) {
                        case "表格视图":
                            frameContent.location.href = "LeaderBusinessTrip.aspx?type=assistant";
                            break;
                        case "日历视图":
                            frameContent.location.href = "AssistantCalendarView.aspx?Index=0";
                            break;
                    }
                }
            }
