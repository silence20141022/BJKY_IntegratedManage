...
namespace Aim.Portal.Services
{
    ...
    public sealed class UserSessionServer : IDisposable
    {
        ...
        // 每隔100秒轮询刷新
        public const long SCAN_INTERVAL = 120000;
        ...
        /// <returns></returns>
        public UserSession GetSessionByLoginName(string loginName)
        {
            UserSession us = Sessions.Values.FirstOrDefault<UserSession>(ent => ent.LogonInfo.LoginName.ToLower() == loginName.ToLower());
    ...
    public class UserSession
    {
        ...
        /// </summary>
        private int _timeOut = 1200;    // 100分钟超时
