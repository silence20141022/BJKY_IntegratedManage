// Business class ImgNewDetail generated from ImgNewDetail
// Creator: Ray
...
{
	[ActiveRecord("ImgNewDetail")]
    public partial class ImgNewDetail : EntityBase<ImgNewDetail>
	{
		...
		public string PId
		{
			...
			set
			{
				if ((_pId == null) || (value == null) || (!value.Equals(_pId)))
				{
					...
					_pId = value;
					RaisePropertyChanged(ImgNewDetail.Prop_PId, oldValue, value);
				}
			}
		...
		public string ImgPath
		{
			...
			set
			{
				if ((_imgPath == null) || (value == null) || (!value.Equals(_imgPath)))
				{
					...
					_imgPath = value;
					RaisePropertyChanged(ImgNewDetail.Prop_ImgPath, oldValue, value);
				}
			}
		...
		public string Content
		{
			...
			set
			{
				if ((_content == null) || (value == null) || (!value.Equals(_content)))
				{
					...
					_content = value;
					RaisePropertyChanged(ImgNewDetail.Prop_Content, oldValue, value);
				}
			}
		...
		public string Remark
		{
			...
			set
			{
				if ((_remark == null) || (value == null) || (!value.Equals(_remark)))
				{
					...
					_remark = value;
					RaisePropertyChanged(ImgNewDetail.Prop_Remark, oldValue, value);
				}
			}
		...
		public string State
		{
			...
			set
			{
				if ((_state == null) || (value == null) || (!value.Equals(_state)))
				{
					...
					_state = value;
					RaisePropertyChanged(ImgNewDetail.Prop_State, oldValue, value);
				}
			}
		...
		public string Ext1
		{
			...
			set
			{
				if ((_ext1 == null) || (value == null) || (!value.Equals(_ext1)))
				{
					...
					_ext1 = value;
					RaisePropertyChanged(ImgNewDetail.Prop_Ext1, oldValue, value);
				}
			}
		...
		public string Ext2
		{
			...
			set
			{
				if ((_ext2 == null) || (value == null) || (!value.Equals(_ext2)))
				{
					...
					_ext2 = value;
					RaisePropertyChanged(ImgNewDetail.Prop_Ext2, oldValue, value);
				}
			}
		...
		public string Ext3
		{
			...
			set
			{
				if ((_ext3 == null) || (value == null) || (!value.Equals(_ext3)))
				{
					...
					_ext3 = value;
					RaisePropertyChanged(ImgNewDetail.Prop_Ext3, oldValue, value);
				}
			}
		...
		public string Ext4
		{
			...
			set
			{
				if ((_ext4 == null) || (value == null) || (!value.Equals(_ext4)))
				{
					...
					_ext4 = value;
					RaisePropertyChanged(ImgNewDetail.Prop_Ext4, oldValue, value);
				}
			}
		...
		public string Ext5
		{
			...
			set
			{
				if ((_ext5 == null) || (value == null) || (!value.Equals(_ext5)))
				{
					...
					_ext5 = value;
					RaisePropertyChanged(ImgNewDetail.Prop_Ext5, oldValue, value);
				}
			}
		...
		public string CreateId
		{
			...
			set
			{
				if ((_createId == null) || (value == null) || (!value.Equals(_createId)))
				{
					...
					_createId = value;
					RaisePropertyChanged(ImgNewDetail.Prop_CreateId, oldValue, value);
				}
			}
		...
		public string CreateName
		{
			...
			set
			{
				if ((_createName == null) || (value == null) || (!value.Equals(_createName)))
				{
					...
					_createName = value;
					RaisePropertyChanged(ImgNewDetail.Prop_CreateName, oldValue, value);
				}
			}
		...
		public DateTime? CreateTime
		{
			...
			set
			{
				if (value != _createTime)
				{
					...
					_createTime = value;
					RaisePropertyChanged(ImgNewDetail.Prop_CreateTime, oldValue, value);
				}
			}
