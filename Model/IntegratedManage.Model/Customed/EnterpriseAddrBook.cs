...
namespace IntegratedManage.Model
{
    ...
    /// </summary>
    [Serializable]
	public partial class EnterpriseAddrBook
    {
        #region 成员变量
        ...
        {
			EnterpriseAddrBook[] tents = EnterpriseAddrBook.FindAll(Expression.In("Id", args));

			foreach (EnterpriseAddrBook tent in tents)
			{
				tent.DoDelete();
			}
        }
