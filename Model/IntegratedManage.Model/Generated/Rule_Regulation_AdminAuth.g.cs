// Business class Rule_Regulation_AdminAuth generated from Rule_Regulation_AdminAuth
// Creator: Ray
...
{
	[ActiveRecord("Rule_Regulation_AdminAuth")]
	public partial class Rule_Regulation_AdminAuth : IMModelBase<Rule_Regulation_AdminAuth>
	{
		...
		public Rule_Regulation_AdminAuth()
		{
		}
		...
		public string Rule_Regulation
		{
			...
			set
			{
				if ((_rule_Regulation == null) || (value == null) || (!value.Equals(_rule_Regulation)))
				{
					...
					RaisePropertyChanged(Rule_Regulation_AdminAuth.Prop_Rule_Regulation, oldValue, value);
				}
			}
		...
		public string UserId
		{
			...
			set
			{
				if ((_userId == null) || (value == null) || (!value.Equals(_userId)))
				{
					...
					_userId = value;
					RaisePropertyChanged(Rule_Regulation_AdminAuth.Prop_UserId, oldValue, value);
				}
			}
		...
		public string UserName
		{
			...
			set
			{
				if ((_userName == null) || (value == null) || (!value.Equals(_userName)))
				{
					...
					_userName = value;
					RaisePropertyChanged(Rule_Regulation_AdminAuth.Prop_UserName, oldValue, value);
				}
			}
