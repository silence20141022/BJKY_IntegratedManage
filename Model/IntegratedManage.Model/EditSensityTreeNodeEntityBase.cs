...
{
    public abstract class EditSensityTreeNodeEntityBase<T> : ModelTreeNodeEntityBase<T>, IEditSensitiveEntity where T : ModelTreeNodeEntityBase<T>, new()
    {
        #region 成员
        ...
        {
            this.EditStatus = EditSensitiveEntityHelper.FullStausString;
        }
